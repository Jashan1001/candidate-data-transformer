...
def normalize_phone(raw: str, default_region: str = "IN") -> tuple[Optional[str], float]:
    """
...
_COUNTRY_ALIASES: dict[str, str] = {
    ...
    "france": "FR", "singapore": "SG", "netherlands": "NL",
    "new zealand": "NZ", "japan": "JP", "china": "CN",
}
...
_SKILL_CANON: dict[str, str] = {
    ...
    "rest": "rest api", "rest api": "rest api", "graphql": "graphql",
}
